...
db.version(9).stores({
    ...
    sales: '++id, date, shopId, fishId, saleType, weight, totalAmount, paymentType, customerId, dueDate',
    ...
    customers: '++id, name, phone, creditLimit',
    customer_payments: '++id, date, customerId, amount',
    buyers: '++id, name, phone',
    buyer_bills: '++id, buyerId, date, dueDate, amount, paidAmount, status',
    buyer_payments: '++id, billId, date, amount'
});
